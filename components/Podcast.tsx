...
const Podcast: React.FC = () => {
  return (
    // ✅ added top padding so content won't hide under fixed navbar
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center mb-8 sm:mb-10">
          ...
          <h1 className="mt-2 text-2xl sm:text-3xl md:text-4xl font-serif text-neutral-900">
            Sparkle in Style Podcast
          </h1>

          <p className="mt-3 max-w-2xl mx-auto text-sm sm:text-base text-neutral-600">
            Real stories from our students about growth, self-confidence and
        ...
        {FEATURED_PODCAST && (
          <section className="mb-8 sm:mb-10">
            ...
            {/* ✅ limit width so the featured thumbnail isn't huge */}
            <div className="mx-auto max-w-4xl">
              <button
                type="button"
                onClick={() => openInNewTab(FEATURED_PODCAST.youtubeUrl)}
                className="group block w-full overflow-hidden rounded-3xl bg-white shadow-lg hover:shadow-xl transition-shadow"
              >
                {/* ✅ controlled height for a more compact hero video */}
                ...
                <div className="px-5 py-4 text-left">
                  ...
                  <p className="mt-1 text-sm text-neutral-600">
                    Watch this student&apos;s story on YouTube.
                  </p>
                </div>
              </button>
            </div>
